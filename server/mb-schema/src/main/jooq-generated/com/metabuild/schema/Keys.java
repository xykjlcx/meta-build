...
public class Keys {
    ...
    public static final UniqueKey<MbNotificationDeliveryLogRecord> MB_NOTIFICATION_DELIVERY_LOG_PKEY = Internal.createUniqueKey(MbNotificationDeliveryLog.MB_NOTIFICATION_DELIVERY_LOG, DSL.name("mb_notification_delivery_log_pkey"), new TableField[] { MbNotificationDeliveryLog.MB_NOTIFICATION_DELIVERY_LOG.ID }, true);
