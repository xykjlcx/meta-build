...
((n, a) => {
  ((o, i) => {
    ...
    const H = J({
        ...
        parseInfix: (e, t) => (
          e.consume('='), { type: 'JsdocTypeOptional', element: P(t), meta: { position: 'suffix' } }
        ),
      }),
      z = J({
        name: 'numberParslet',
      ...
      return J({
        ...
        parsePrefix: (r) => {
          ...
          if (r.consume('StringValue'))
            ...
            let x = '';
            const k = ['Identifier', '@', '/'];
            while (k.some((S) => r.consume(S))) (x += y.text), (y = r.lexer.current);
            c = {
              type: 'JsdocTypeSpecialNamePath',
              value: x,
              specialType: s,
      ...
      return J({
        ...
        parseInfix: (c, y) => {
          ...
          if (
            ...
            return (
              c.acceptLexerState(k), { type: 'JsdocTypeJsdocObjectField', left: P(y), right: S }
            );
          }
        },
      });
    ...
    const Le = [
      ...
      je = J({
        ...
        accept: (e) => e === 'typeof',
        parsePrefix: (e) => (
          e.consume('typeof'), { type: 'JsdocTypeTypeof', element: e.parseType(m.KEY_OF_TYPE_OF) }
        ),
      }),
      zt = [
    ...
    const nn = J({
        ...
        accept: (e) => e === 'keyof',
        parsePrefix: (e) => (
          e.consume('keyof'), { type: 'JsdocTypeKeyof', element: P(e.parseType(m.KEY_OF_TYPE_OF)) }
        ),
      }),
      rn = J({
        name: 'importParslet',
