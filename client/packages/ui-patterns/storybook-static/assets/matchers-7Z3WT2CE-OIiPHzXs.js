...
function Be() {
  const e = new Map();
  for (const [r, n] of Object.entries(R)) {
    for (const [i, c] of Object.entries(n))
      (R[i] = { open: `\x1B[${c[0]}m`, close: `\x1B[${c[1]}m` }), (n[i] = R[i]), e.set(c[0], c[1]);
  ...
  return (
    ...
    Object.defineProperties(R, {
      ...
      hexToAnsi256: { value: (r) => R.rgbToAnsi256(...R.hexToRgb(r)), enumerable: !1 },
      ansi256ToAnsi: {
        value(r) {
          if (r < 8) return 30 + r;
      ...
      rgbToAnsi: { value: (r, n, i) => R.ansi256ToAnsi(R.rgbToAnsi256(r, n, i)), enumerable: !1 },
      hexToAnsi: { value: (r) => R.ansi256ToAnsi(R.hexToAnsi256(r)), enumerable: !1 },
    }),
    R
  );
}
...
var W = qe,
  ...
  F = (e, r) => () => (r || (0, e[Ne(e)[0]])((r = { exports: {} }).exports, r), r.exports),
  Je = (e, r, n, i) => {
    if ((r && typeof r == 'object') || typeof r == 'function')
      for (const c of Ne(r))
        !Ke.call(e, c) &&
          c !== n &&
          Re(e, c, { get: () => r[c], enumerable: !(i = Ve(r, c)) || i.enumerable });
    return e;
  },
  Xe = (e, r, n) => (
    (n = e != null ? We(He(e)) : {}), Je(Re(n, 'default', { value: e, enumerable: !0 }), e)
  ),
  ve = F({
  ...
  nt = F({
    'node_modules/pretty-format/build/plugins/DOMElement.js'(e) {
      ...
      var a = (E, O, A, w, B, G) => {
        ...
        const L = l(E) ? 'DocumentFragment' : E.tagName.toLowerCase();
        return ++w > O.maxDepth
  ...
  st = F({
    'node_modules/pretty-format/build/index.js'(e) {
      ...
      function P(t, b, T, M, S, f) {
        ...
        (S = S.slice()), S.push(t);
        const v = ++M > b.maxDepth,
          I = b.min;
        if (b.callToJSON && !v && t.toJSON && typeof t.toJSON == 'function' && !f)
...
${U}`,
      ...
      function z(t, b, T, M, S, f) {
        ...
        const I = N(t, b.printFunctionName, b.escapeRegex, b.escapeString);
      ...
      var ee = (t) =>
        ...
        le = (t) => {
          ...
          return {
            ...
            plugins: (v = t == null ? void 0 : t.plugins) !== null && v !== void 0 ? v : k.plugins,
            printBasicPrototype:
              (I = t == null ? void 0 : t.printBasicPrototype) !== null && I !== void 0 ? I : !0,
...
function ye(e, r = 10, n = 10) {
  ...
  try {
    ...
    c = (0, be.format)(e, { callToJSON: !1, maxDepth: r, maxWidth: n, min: !0, plugins: Ce });
  }
