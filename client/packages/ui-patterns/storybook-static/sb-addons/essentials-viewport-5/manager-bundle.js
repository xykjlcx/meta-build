try {
  (() => {
                  ...
                  return (I) => {
                    var u = () => {
                      ...
                      return (
                        ...
                        x || ((R = I.apply(null, arguments)), h.set(arguments[S], R)),
                        n > 0 &&
    ...
    var $ = Se(le()),
      ...
      Ge = Q(() => {
        const [e, t] = G(),
          { viewports: a = ue, defaultOrientation: s, defaultViewport: c, disable: b } = F(A, {}),
          p = Pe(a),
          o = oe(),
          [i, m] = N(!1);
        c &&
          ...
          b || Object.entries(a).length === 0
            ...
            : l.createElement(
                ...
                l.createElement(
                  ...
                  {
                    placement: 'top',
                    tooltip: ({ onHide: I }) => l.createElement(q, { links: Ve(p, n, t, I) }),
                    closeOnOutsideClick: !0,
                    onVisibleChange: m,
                  },
                  l.createElement(
