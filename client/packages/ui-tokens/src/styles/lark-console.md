...
lark-console 风格呈现的是**企业办公 SaaS 管理后台的扁平蓝美学**：以纯白背景为主画布，飞书蓝 (`#3370ff` ≈ `oklch(0.62 0.214 259)`) 作主色，浅蓝 (`#e1ecff` ≈ `oklch(0.93 0.04 259)`) 作激活底色，左侧模块 Sidebar 用极浅灰 (`#f5f6f7` ≈ `oklch(0.985 0 0)`) 承托，整体气质对标飞书管理后台——企业感、扁平、蓝色驱动。
...
- 别用 Tab 下划线激活（lark-console 是 pill，不是 underline）
