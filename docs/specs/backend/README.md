...
| [02-infra-modules.md](./02-infra-modules.md) | 12 个 `mb-infra` 子模块清单 | 用基础设施能力 / 加新基础设施 |
...
| 7 | 后端框架 | Spring Boot 3.5.3（JDK 21 LTS） | — |
...
| 10 | 基础设施 | 12 个 `mb-infra` 子模块 | ADR-0002 |
...
| 其他文档 | 关系 |
|---------|-----|
| `frontend/README.md` | 通过契约驱动（@mb/api-sdk）与本文档解耦，互不依赖 |
...
| **使用者，要加自己的业务模块** | [03-platform-modules.md §5](./03-platform-modules.md) → [05-security.md](./05-security.md) → [04-data-persistence.md](./04-data-persistence.md) → [06-api-and-contract.md](./06-api-and-contract.md) |
