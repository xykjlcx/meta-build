...
3. **最小可用默认实现**：
   ...
   - 8 个业务组件（[04 §3](./04-ui-patterns.md#3-8-个核心业务组件清单)）
...
**改的对象**：NxTable / NxForm / NxFilter / NxDrawer / NxBar / NxLoading / ApiSelect / NxTree 8 个业务组件之一的内部实现。
...
| 8 个业务组件 + L3 不硬编码业务语义 | [04-ui-patterns.md](./04-ui-patterns.md) |
