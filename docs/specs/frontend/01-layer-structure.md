...
| L2 | `@mb/ui-primitives` | 原子组件与布局基础件（shadcn/Radix 风格）| Radix UI / shadcn primitives / CVA / clsx |
| L3 | `@mb/ui-patterns` | 业务组件与页面骨架（NxTable / NxForm / PageHeader / ...）| TanStack Table / React Hook Form / Zod / date-fns |
...
| 定制深度 | 任意改 L1-L5 源码（包括底座的原子组件与页面骨架） | 通过 props / theme override / shadcn 式复制源码 |
