...
| L2 | `@mb/ui-primitives` | 29 个原子组件（shadcn/Radix 风格）| Radix UI / shadcn primitives / CVA / clsx |
...
| 定制深度 | 任意改 L1-L5 源码（包括底座的 29 个原子组件） | 通过 props / theme override / shadcn 式复制源码 |
...
| L2 `@mb/ui-primitives` | shadcn/ui CLI 拷贝 + meta-build 调整 | 29 个原子组件，参考 shadcn 默认实现 |
